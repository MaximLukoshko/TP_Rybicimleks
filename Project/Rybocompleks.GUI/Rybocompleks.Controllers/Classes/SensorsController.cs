...
namespace Rybocompleks.Controllers
{
    public class SensorsController : ISensorsController
    {
        ...
        public SensorsController()
        {
            ...
            physicalObjectsController.AddObject(new TemperatureSensor(new Location(50, 30)));
            physicalObjectsController.AddObject(new TemperatureSensor(new Location(80, 30)));
            physicalObjectsController.AddObject(new OxygenSensor(new Location(50, 80)));
            physicalObjectsController.AddObject(new PhSensor(new Location(20, 60)));
            physicalObjectsController.AddObject(new LightSensor(new Location(0, 0)));
        }
